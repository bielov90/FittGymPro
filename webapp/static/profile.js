...
async function loadProfile() {
  ...
  const result = document.getElementById("profile-result");
  result.innerHTML = `
    <p class="text-lg font-semibold text-blue-600 mb-2">📋 Данные профиля загружены</p>
    <p>Дневная норма: <b>${user.calories}</b> ккал и <b>${(user.water/1000).toFixed(1)}</b> л воды</p>
  `;
}
